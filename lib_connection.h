...
void gclient_handler(void *gclient,int socket);
...
void handler_message(char *recived_message,
                     int msg_leng, int socket)__attribute_deprecated_msg__("depreciated todo : remove");
